...
export default class {
  ...
  handleEditTicket(e, bill, bills, index) {
    // console.log(index);
    if (this.counter1 === undefined) this.counter1 = 0;
    if (this.counter2 === undefined) this.counter2 = 0;
    if (this.counter3 === undefined) this.counter3 = 0;
    this.billGroup = index;
    ...
    switch (index) {
      ...
      case 3: {
        counter = this.counter3;
        break;
      }
    }

    // test - afficher une icone si le Bill est de même groupe !!!
    const str = '';
    if (str.includes(''));
    {
